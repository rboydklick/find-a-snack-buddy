#Find a Snack Buddy
> Find someone to get a snack with.

[![Build Status](https://travis-ci.org/rboydklick/find-a-snack-buddy.svg?branch=master)](https://travis-ci.org/rboydklick/find-a-snack-buddy) [![Dependency Status](https://david-dm.org/rboydklick/find-a-snack-buddy.svg)](https://david-dm.org/rboydklick/find-a-snack-buddy) [![devDependency Status](https://david-dm.org/rboydklick/find-a-snack-buddy/dev-status.svg)](https://david-dm.org/rboydklick/find-a-snack-buddy#info=devDependencies)
...
## Release History
 * 2014-06-11   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)